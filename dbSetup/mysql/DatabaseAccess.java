...
public class DatabaseAccess {
    ...
    // LogManager.getLogger(DatabaseAccess.class);
    ...
    public DatabaseAccess(String url, String user, String password) throws Exception {
        ...
        try {
            ...
            // logger.error("Connection to database failed! Please make sure the RDS server
            // is correct, the tunnel is enabled, and you have run the mysql command to
            // create the database:\n" + e.getMessage());
            System.exit(1);
        }
    }
