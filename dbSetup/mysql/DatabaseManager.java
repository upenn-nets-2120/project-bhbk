 ...
 * <p>
 * We want to use the
 * <a href="https://refactoring.guru/design-patterns/singleton">*singleton*
 * design pattern</a>
 * so we can, for instance, put a "mock object" to emulate the database
 * connection.
 */
public class DatabaseManager {
    ...
    public static DatabaseAccess getDatabase() {
        if (theDatabase == null) {
            try {
                theDatabase = new DatabaseAccess(Config.DATABASE_CONNECTION, Config.DATABASE_USERNAME,
