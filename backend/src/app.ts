...
import { createNewChat, getChatBetweenTwoUsers, getMessagesByChatId } from "./views/chat";
...
app.get('/api/chat/:chatId/messages', checkAuthentication, async (req, res, next) => {
  try {
